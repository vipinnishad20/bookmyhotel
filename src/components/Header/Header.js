  ...
  return (
    <nav className='navbar'>
      <div className='container'>
        ...
        <ul className="inrFlag">
        <li><p className="inrNav">INR</p></li>
        <li><img  className="flagNav" src ="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReVzBIMPnDHO2UsURnJrNQr3CRGTtVSYSya7LleezMFg&s" style={{width:"30px"}}/></li>
        </ul>
          ...
          <ul>
            <li>
              <Link to='/'>
                ...
                <button type='button' class='btn btn-outline-warning btn1'>
